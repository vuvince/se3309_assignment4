...
module.exports = {
    ...
    addPlayer: (req, res) => { //comment missing
        if (!req.files) {
        ...
        let usernameQuery = "SELECT * FROM `players` WHERE user_name = '" + username + "'"; //comment missing

        db.query(usernameQuery, (err, result) => { //comment missing
            if (err) {
    ...
    deletePlayer: (req, res) => {
        let playerId = req.params.id;
        let getImageQuery = 'SELECT image from `players` WHERE id = "' + playerId + '"'; //comment missing
